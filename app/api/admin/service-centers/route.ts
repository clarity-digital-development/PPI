...
const centerCreateSchema = z.object({
  ...
  // Road-mile pricing (Ryan 2026-09-08). freeRadiusMiles is what switches a
  // centre off the legacy minute bands; null keeps it on them.
  ...
  try {
    ...
    await audit({
      ...
      metadata: {
        ...
        freeRadiusMiles: center.freeRadiusMiles,
        includedOverageMiles: center.includedOverageMiles,
        perMileCents: center.perMileCents,
        baseFeeCents: center.baseFeeCents,
